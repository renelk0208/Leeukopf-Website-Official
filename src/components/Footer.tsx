    ...
    <div className="flex items-center gap-2 sm:gap-3">
      {socialMedia.map((social) => (
        <a
          ...
          className="group relative flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gray-800 hover:bg-gray-700 rounded-lg transition-all duration-300 hover:scale-110 min-w-[44px] min-h-[44px]"
