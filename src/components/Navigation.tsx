        ...
        <div className="w-full max-w-screen-2xl mx-auto px-2 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center h-20">
              ...
              <ul className="flex items-center justify-center flex-nowrap gap-x-0 min-w-0">
                {navItems.map((item) => (
                  <li key={item.path} className="nav-item shrink-0">
                    <Link
                      to={item.path}
                      className={`block px-1 xl:px-1.5 2xl:px-2 py-2 text-[11px] xl:text-xs 2xl:text-sm font-medium transition-colors whitespace-nowrap ${
                        isActive(item.path)
            ...
            <div className="flex items-center space-x-2 flex-shrink-0 ml-2">
              <div className="hidden 2xl:flex items-center gap-2 pr-2 text-xs text-gray-500">
