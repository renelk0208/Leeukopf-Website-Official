...
export const categoryHero: Record<string, string> = {
  ...
  'liquid-polygel': '/img/products/liquid polygel/liquid-polygel-category-hero-image.webp',
...
export const subcategoryImages: Record<string, Record<string, string[]>> = {
  'gel-polish': {
    ...
    'spring-summer-26': [
      '/img/products/gel_polishes/spring-summer-26/spring-summer-26 category.jpg',
      '/img/products/gel_polishes/spring-summer-26/spring-summer-1.jpg',
      '/img/products/gel_polishes/spring-summer-26/spring-summer-2.jpg',
      '/img/products/gel_polishes/spring-summer-26/spring-summer-3.jpg',
      '/img/products/gel_polishes/spring-summer-26/spring-summer-4.jpg',
      '/img/products/gel_polishes/spring-summer-26/spring-summer-5.jpg',
