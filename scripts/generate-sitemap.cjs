...
// All indexable pages on the website.
// Keep in sync with the routes defined in src/App.tsx and src/config/seoRoutes.ts.
// Do NOT include: redirects, auth-protected routes, internal/test routes, or legacy aliases.
const pages = [
  // Main pages
