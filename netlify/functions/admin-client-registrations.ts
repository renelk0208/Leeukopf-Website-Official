...
export const handler: Handler = async (event) => {
  ...
  let registrationsQuery = adminSupabase
    ...
    .select('id, company, contact, role, email, phone, country, website, instagram, business_type, interests, monthly_volume, vat_eori, billing_address, shipping_address, language, notes, created_at')
